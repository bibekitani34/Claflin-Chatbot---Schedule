...
try {
	$con /*just a variable to hold the connection and use in all pages*/ = new PDO('mysql:host=localhost; dbname=u770624762_claflin', 'u770624762_claflin'/*username*/, 'Page2905'/*password*/);
